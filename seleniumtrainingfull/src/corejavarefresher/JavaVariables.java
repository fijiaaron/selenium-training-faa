...
public class JavaVariables {
	...
	public static void main(String[] args) {
		...
		byte monthInNumber; /* 8 bits signed. saves memory in large array. */
		...
		System.out.println("Revised Salary is - " + salary
				+ "And the bonus is - " + bonus);
		...
		/*
		 * If we do not use method chaining then the expression above have to be
		 * split in two lines as given below
		 */
		String upper = name.toUpperCase();
		boolean checkThis = upper.equals("CEDRIC");

		/*
		 * Data Type Default Value byte 0 short 0 int 0 long 0L
		 * 
		 * boolean false
		 * 
		 * char '\u0000'
