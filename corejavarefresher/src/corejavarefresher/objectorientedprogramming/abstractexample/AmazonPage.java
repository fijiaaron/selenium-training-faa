/*
 * The AmazonPage class inherits LoadableComponent
...
public class AmazonPage extends LoadableComponent {

	String url = "http://www.amazon.com";
	String expectedPageTitle = "Amazon home";
	private String actualTitleFromPage;

	public AmazonPage(String componentName, String actualTitleFromPage) {
		super(componentName);
